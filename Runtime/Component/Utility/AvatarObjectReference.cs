// Based on https://github.com/bdunderscore/modular-avatar/blob/7a36acb3de00855c16abd927852f8f41223959aa/Runtime/AvatarObjectReference.cs
// Copyright (c) 2022 bd_ - MIT License
...
namespace /* nadena.dev.modular_avatar.core */ Numeira
{
    [Serializable]
    public class AvatarObjectReference
    {
        ...
        public static GameObject Get(SerializedProperty prop)
        {
            ...
            var avatarRoot = RuntimeUtil.FindAvatarInParents((rootObject as Component)?.transform ?? (rootObject as GameObject)?.transform);
        ...
        public static void Set(SerializedProperty prop, GameObject target)
        {
            ...
            prop.FindPropertyRelative(nameof(AvatarObjectReference.referencePath)).stringValue = referencePath;
            prop.FindPropertyRelative(nameof(AvatarObjectReference.targetObject)).objectReferenceValue = target;
        }
#endif
        ...
        public GameObject Get(Component container)
        {
            ...
            var avatarTransform = RuntimeUtil.FindAvatarInParents(container.transform);
